...
# YOUR CODE HERE!
print("The available number of loans are:", len(loan_costs))
...
print(f"The total loan amounts is: ${loan_total}")
...
print(f"The discounted rate: {present_value:.2f}")
...
def calculate_present_value(new_loan):
    present_value = new_loan["future_value"] / (1 + (new_loan["remaining_months"]/12)) ** annual_discount_rate
...
for i in range(len(loans)):
    if loans[i] ["loan_price"] <= 500:
        inexpensive_loans.append(loans[i])
    
# @TODO: Print the `inexpensive_loans` list
# YOUR CODE HERE!
print("Here are the inexpensive loans:", inexpensive_loans)
